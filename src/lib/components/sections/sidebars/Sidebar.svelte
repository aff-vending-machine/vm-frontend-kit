...
<div
  class:hidden={!sidebar || media.isDesktop}
  class="absolute bottom-0 left-0 right-0 top-0 z-10 bg-neutral opacity-50"
/>
<aside
...
>
  ...
  >
    ...
    <ul class="mt-8" class:hidden={!sidebar && !media.isDesktop}>
